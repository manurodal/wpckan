<?php
  ...
  */
  ...
  function wpckan_get_dataset_notes($dataset_id){
    wpckan_log("wpckan_get_dataset_notes "  . print_r($dataset_id,true));
    ...
    if (!(isset($dataset)) || empty($dataset)):
      return $dataset_id;
		...
		return wpckan_get_multilingual_value("notes",$dataset);
  }
